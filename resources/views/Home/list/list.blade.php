...
@section('content')
        <div class="nav_list fl">
          <ul class="clearfix">
            ...
            <li class="">
              <a href="http://www.51ttfl.com/category.php?id=263">游戏外设
                <span></span></a>
            </li>
            <li class="">
              <a href="category.php?id=244">创意数码
                <span></span></a>
            </li>
            <li class="">
              <a href="category.php?id=260">VR-虚拟现实
                <span></span></a>
            </li>
            <li class="" id="zn" style="display: none;">
              <a style="color:red;" id="ttl_9" href="http://yhs999.cn/index.php?r=nine&u=361075" target="_blank">
                <font style="font-size: 23px">9块9</font>包邮专区</a></li>
            <li class="" id="zm" style="display: none;">
              <a style="color:red;font-size: 18px;font-weight: 600;width: 157px;" id="ttl_yz" class="wztx" href="http://yhs999.cn/index.php?r=nine&u=361075" target="_blank">周末
                <font style="font-size: 25px">1折</font>秒杀</a></li>
          </ul>
        </div>
        ...
        <div class="photo">
          ...
          <div class="c-2">周一至周六 9:30-19:30</div></div>
      </div>
    </div>
      ...
      <div class="main">
        <div class="search-box">
          <div class="search-nav">当前位置:
            <a href=".">首页</a>
            <code>&gt;</code>
            <a href="category.php?id=263">游戏外设</a></div>
        </div>
        <div class="filter-box">
          ...
          <div class="filter js-sort last">
            ...
            <a class="item-default active" href="category.php?category=263&display=grid&keywords=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=ASC#goods_list">默认</a>
            <a class="item-latest " href="category.php?category=263&display=grid&keywords=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">最新</a>
            <a class="item-prize " href="category.php?category=263&display=grid&keywords=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=DESC#goods_list">价格
              <i class="active"></i></a>
          </div>
        </div>
      </div>
        ...
        <div class="list-container" id="j-list">
          <ul class="list">
            <li class="list-item">
              <dl class="desc">
                <dt class="pic">
                  <a target="_blank" href="/Home/details">
                    <img src="/Home/images/1430_thumb_G_1521051519055.jpg"></a>
                </dt>
                <dd class="cont">
                  <a target="_blank" href="">
                    <span class="column-title">入耳式运动耳机电脑手机通用苹果重低音魔音</span>
    ...
    <div class="footer">
      <div class="footer-content main">
        <div class="c-1 clearfix">
          <div class="item-1">
            <img src="/Home/picture/footer.png"></div>
          <div class="item-2">
            <div class="ewm-box">
              <img src="/Home/picture/gzh.jpg"></div>
        ...
        <div class="foot_info_list">
          ...
          <p class="mgt">Copyright ©2016 深圳市智盈优创网络科技有限公司51ttfl.com All Rights Reseryved&nbsp粤ICP备16046348号-1&nbsp;</p></div>
      </div>
    </div>
      ...
      <div class="modal-main-c">
        ...
        <div class="bd">
          <form id="loginForm" action="user.php" method="post" novalidate onSubmit="return false">
            ...
            <input type="hidden" id="back_act" name="back_act" value='/category.php?id=263' />
            <div class="div_input">
              <input class="input_text" id="username" name="username" placeholder="请输入账户名" type="text"></div>
            <div class="div_input">
              <input class="input_text" id="password" name="password" placeholder="请输入密码" type="password"></div>
            <div class="yzm clearfix" style="display:none">
              ...
              <span class="span_yzm">
                <img id="captchaImage" class="captchaImage" src="" title="点击更换验证码" onClick="this.src='captcha.php?is_login=1&'+Math.random()" style="vertical-align:top;cursor: pointer;width: 80px;height: 36px;"></span>
            </div>
            <div class="div_save clearfix">
              <div class="save-news">
                <label>
                  <input type="checkbox" id="isRememberUsername" class="check" name="remember" checked="" value="checkbox">
                  <span class="s0">保存登录信息</span></label>
              </div>
              <div class="forget-ps">
                <a href="user.php?act=get_password" target="" title="">忘记密码?</a></div>
            </div>
            <div class="div_login">
              <input class="submit" type="submit" id="loginSubmit" value="立即登录" /></div>
            <div class="oth_logins">
              <h2>
                <span class="lie"></span>
                <span class="zc">免注册，一键登录</span></h2>
              <div class="login_icons clearfix">
                <a href="user.php?act=oath&type=weixin&callblock=/category.php?id=263" class="lg_wx"></a>
                <a class="lg_qq" href="user.php?act=oath&type=qq&callblock=/category.php?id=263"></a>
                <a href="user.php?act=oath&type=weibo&callblock=/category.php?id=263" class="lg_sina"></a>
              </div>
            </div>
            <div class="div_no_zh">还没有账号?
              <a href="javascript:;" title="" target="" class="login-fast">点击注册</a></div>
          </form>
        </div>
      </div>
      <div class="modal-main-c-2">
        ...
        <div class="bd">
          <form action="user.php" name="formUser" id="registerForm" method="post">
            ...
            <div class="div_input">
              <input class="input_text" id="username_2" name="username" placeholder="请输入账户名" type="text"></div>
            <div class="div_input">
              <input class="input_text" id="password_2" name="password" placeholder="请输入6-16位密码" type="password"></div>
            <div class="div_input">
              <input class="input_text" id="rePassword" name="rePassword" placeholder="请确认输入密码" type="password"></div>
            <div class="div_input">
              <input class="input_text" id="email" name="email" placeholder="请输入邮箱" type="text"></div>
            <div class="yzm clearfix">
              <input class="input_text captcha" id="captcha" name="captcha" placeholder="请输入验证码" type="text">
              <span class="span_yzm">
                <img id="captchaImage" src="" onClick="this.src='captcha.php?'+Math.random()" style="vertical-align:top;cursor: pointer;width: 80px;height: 36px;"></span>
            </div>
            <div class="futk">
              <label>
              ...
              <label class="brown" style="width: 84px;">
                <a href="javascript:;" onclick="openStaticPopup()" style="color: #67a4db">《我要天天福利商城服务协议条款》</a></label>
            </div>
            <div class="div_login">
              <input class="submit" type="submit" value="立即注册" /></div>
            <div class="div_no_zh">已有账号?
              <a href="javascript:;" title="" target="" class="registered-fast">马上登录</a></div>
          </form>
        </div>
      </div>
        ...
        <div class="wpa3-select-panel-main">
          ...
          <div class="wpa3-select-panel-selects">
            <a id="wpa3-select-panel-aio-chat" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2587743823&site=qq&menu=yes" class="wpa3-select-panel-chat wpa3-select-panel-aio-chat">
              ...
              <span class="wpa3-select-panel-label">客服</span></a>
          </div>
        </div>
        <div class="wpa3-select-panel-bottom">
          <a target="_blank" href="http://im.qq.com" class="wpa3-select-panel-install">安装qq</a></div>
      </div>
    </div>
    <div class="popup">
      ...
      <div class="popup_body">
        <div class="con">
          ...
          <ul>
            ...
            <li>(3)不可抗力，例如：自然灾害、交通戒严、突发战争等。</li></ul>
          <b>五、服务条款的修改</b>
          ...
          <ul>
            ...
            <li>(3)不干扰或混乱网络服务。</li>
            <li>(4)遵守所有使用网络服务的网络协议、规定、程序和惯例。</li></ul>
      ...
      <div class="popup_close">
        <a href="javascript:;" onclick="closePopupLayer()" title="关闭窗口">阅读完毕，关闭窗口</a></div>
    </div>
    <style type="text/css">.tc{position:fixed;right:20px;bottom:-250px;width:400px;height:215px;border:1px solid #e4e4e4;border-radius: 5px;background: white;z-index: 9999; } .tt{width:80%;height:35px;line-height: 35px;margin:0 auto;text-align: center;margin-top:20px;} .tt a{color:#ff6700;font-size: 16px;} .cont a{font-size: 15px;} .cont{width:80%;height:25px;line-height: 25px;margin:0 auto;font-size: 15px;} .close_tc{position:absolute;right:5px;top:5px;background:url("/Home/images/close_tc.png") no-repeat; background-size:100% 100%;display:block;width:15px;height:15px;cursor:pointer;}</style>
    <div class="tc">
      <span class="close_tc"></span>
      <p class="tt">
        <a href="http://www.51ttfl.com/article.php?id=40" title="点击查看">尊敬的用户，您好！</a></p>
      <p class="cont">
        <a href="http://www.51ttfl.com/article.php?id=40" title="点击查看">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;中秋国庆双节到来10月1日-10月8日快递、工厂、客服人员放假休息。本商城正常下单，发货时间将顺延到节后，期间有任何问题您可以在线QQ客服上留言，上班第一时间回复处理。给您带来的不便我们深感抱歉，敬请谅解，祝双节快乐！</a></p>
    </div>
    <script type="text/javascript">function getsec(str) {
    ...
    <style type="text/css">.zzp{width:100%;height:100%;position: fixed;top:0;left:0;background: gray;opacity: 0.8;z-index: 9999;display: none;} #qiandao-rule-list {color: #8d8ebb;font-size: 1pc;line-height: 26px} }</style>
    <div class="zzp"></div>
          ...
          <div class="qiandao-con clear">
            <div class="qiandao-left">
              <div class="qiandao-left-top clear" style="height:36px;">
                ...
                <!-- <div class="qiandao-history qiandao-tran qiandao-radius" id="js-qiandao-history">我的签到</div> --></div>
            ...
            <div class="qiandao-right">
              <div class="qiandao-top">
                ...
                <p class="qiandao-notic">已经签到
                  <span style="color:#b25d06 !important;text-align:center;font-size:18px !important;">0</span>天</p></div>
      ...
      <div class="qiandao-layer qiandao-active">
        <div class="qiandao-layer-con qiandao-radius" style="width:365px;height:365px;">
          ...
          <div class="yiqiandao clear" style="margin-top:131px;margin-left:64px;height:200px">
            ...
            <!-- 您已连续签到<span>2</span>天 --></div>
          <!-- <div class="qiandao-jiangli qiandao-sprits">
          <span class="qiandao-jiangli-num">0.55<em>元</em></span></div>
          <a href="#" class="qiandao-share qiandao-tran">分享获取双倍收益</a> --></div>
        <div class="qiandao-layer-bg"></div>
      </div>
    </div>
  ...
  <div style="display:none;">
    <script>var _hmt = _hmt || []; (function() {
        ...
        hm.src = "/Home/hm.js?b9bdbc783b993a3eece5a862a3ab6445";
  ...
  <script>var _hmt = _hmt || []; (function() {
      var hm = document.createElement("script");
      hm.src = "/Home/hm.js?2bbf2912a175d7ef8ebc9926036abfab";
      var s = document.getElementsByTagName("script")[0];
      s.parentNode.insertBefore(hm, s);
    })();</script>
  <div style="display:none;">
    <script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://": " http://");
      document.write(unescape("%3Cspan id='cnzz_stat_icon_1261759893'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s4.cnzz.com/z_stat.php%3Fid%3D1261759893%26show%3Dpic' type='text/javascript'%3E%3C/script%3E"));</script>
  </div>
  ...
  <script>/*商品栏目*/
    $("#j-list li").hover(function() {
      $("#js-clone-item").addClass('active').empty().append($(this).html()).stop().show().animate({
    ...
    function() {
      if ($("#js-clone-item").hasClass('active')) {
        $("#js-clone-item").live('mouseleave',
        function() {
          $(this).removeClass('active').empty().stop().hide();
        })
      }
    });
    $(".filter-box .filter").find("a").on("click",
    function() {
