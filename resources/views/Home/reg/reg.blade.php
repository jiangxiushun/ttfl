...
<div class="header">
    ...
    <div class="logo_right">
        <p>我已经注册，现在就<a href="user.php">登陆 >></a></p>
    </div>
</div>
                    ...
                    <ul class="registration_ul">
                        ...
                        <li>
                            ...
                            <div class="text_div fl regi_inp_yz">
                                <input name="captcha" class="text captcha" id="captcha" type="text" placeholder="请输入验证码"/>
                    
                            </div>
                            <span class="">
                              <img id="captchaImage" src="picture/captcha.php" alt="captcha" style="vertical-align:top;cursor: pointer;" onClick="this.src='captcha.php?'+Math.random()" /> 
                            </span>
    ...
    <div class="modal-main-c">
        ...
        <div class="bd">
            ...
            <form id="loginForm" action="user.php" method="post" novalidate onSubmit="return false">
                ...
                <input type="hidden" id="back_act" name="back_act" value='index.php'/>
                <div class="div_input">
                ...
                <div class="yzm clearfix" >
                    <input type="text" id="captcha" name="captcha"  class="captcha" maxlength="4" autocomplete="off" placeholder="请输入验证码">
                    <span class="span_yzm">
                ...
                <div class="oth_logins">
                    ...
                    <div class="login_icons clearfix">
                        <a href="user.php?act=oath&type=weixin&callblock=index.php" class="lg_wx"></a>
                        <a class="lg_qq" href="user.php?act=oath&type=qq&callblock=index.php"></a>
                        <a href="user.php?act=oath&type=weibo&callblock=index.php" class="lg_sina"></a>
                    </div>
                </div>
                <div class="div_no_zh">
