...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        <form class="mws-form" action="/admin/good/{{$data->id}}" method="post" enctype="multipart/form-data">
        	{{ csrf_field() }}
        	{{ method_field('PUT')}}
            <div class="mws-form-inline">
                ...
                <div class="mws-form-row">
                    <label class="mws-form-label">商品价格</label>
                        <div class="mws-form-item" style="width: 200px; padding-right: 84px;">
                            <input type="text" class="small"  name="price" value="{{$data->price}}"><img src="/Admin/img/1.jpg" style="width:20px">
                        </div>
                </div>
                <div class="mws-form-row">
