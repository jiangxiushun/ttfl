    ...
    a.extend(a.validator, {
        ...
        prototype: {
            ...
            showErrors: function(b) {
                ...
                if(this.settings.showErrors){console.log("true");}
            ...
            hideThese: function(a) {
                ...
                this.addWrapper(a).html("<i class='yes'></i>").show();
            },
            valid: function() {
                return 0 === this.size()
            },
            ...
            defaultShowErrors: function() {
                ...
                this.showLabel(c.element, "<i></i>"+c.message);
            ...
            showLabel: function(b, c) {
                ...
                g.length ? (g.removeClass(this.settings.validClass).addClass(this.settings.errorClass), g.html(c)) : (g = a("<" + this.settings.errorElement + ">").attr("id", h + "-error").addClass(this.settings.errorClass).html(c || ""), d = g, this.settings.wrapper && (d = g.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()), this.labelContainer.length ? this.labelContainer.append(d) : this.settings.errorPlacement ? this.settings.errorPlacement(d, a(b)) : d.insertAfter(b), g.is("label") ? g.attr("for", h) : 0 === g.parents("label[for='" + h + "']").length && (f = g.attr("id").replace(/(:|\.|\[|\])/g, "\\$1"), i ? i.match(new RegExp("\\b" + f + "\\b")) || (i += " " + f) : i = f, a(b).attr("aria-describedby", i), e = this.groups[b.name], e && a.each(this.groups,
                function(b, c) {
                ...
                g.parent(".regi_inp").find(".fieldErrorsd").remove();
            },
