(function($){
	...
	$.fn.jqueryzoom = function(options){
		...
		$(this).hover(function(){
			...
			var imageWidth =  $(this).children().children('img').get(0).offsetWidth;
			var imageHeight = $(this).children().children('img').get(0).offsetHeight;


			noalt= $(this).children("img").attr("alt");

			var bigimage = $(this).children().children("img").attr("jqimg");
